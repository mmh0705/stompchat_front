...
export default function Home() {
  ...
  return (
    <div className="grid grid-rows-[20px_1fr_20px] items-center justify-items-center p-8 pb-20 gap-16 sm:p-20 font-[family-name:var(--font-geist-sans)] min-h-[calc(100vh-120px)]">
      <main className="flex flex-col gap-8 row-start-2 items-center sm:items-start">
        ...
        카카오 로그인
        <a href={'https://kauth.kakao.com/oauth/authorize?client_id=d9d1c24e59bc7233b5127e22af2e2857&redirect_uri=http://'+ apiIP +'/api/oauth/kakao&response_type=code'}>
